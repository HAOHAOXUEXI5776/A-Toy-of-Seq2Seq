...
# @Author: Qin WT
# @Time: 2019/7/7 20:00
# model：1 layer rnn，unidirectional encoder
...
tf.app.flags.DEFINE_string('logdir', 'log/1/', 'help')
tf.app.flags.DEFINE_string('testdir', 'test/1/', 'help')
# module parameters
...
encoder = opennmt.encoders.UnidirectionalRNNEncoder(1, 512)
decoder = opennmt.decoders.RNNDecoder(1, 512, bridge=opennmt.layers.CopyBridge())
