...
# @Author: Qin WT
# @Time: 2019/7/8 9:31
# model：1 layer rnn，bidirectional encoder, with attention
...
tf.app.flags.DEFINE_string('logdir', 'log/4/', 'help')
tf.app.flags.DEFINE_string('testdir', 'test/4/', 'help')
# module parameters
...
# train or test
tf.app.flags.DEFINE_boolean('is_train', False, 'help')
...
encoder = opennmt.encoders.BidirectionalRNNEncoder(1, 512)
decoder = opennmt.decoders.AttentionalRNNDecoder(1, 512, bridge=opennmt.layers.CopyBridge())
